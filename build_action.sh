...
# install dep 
apt update
apt install -y wget xz-utils make gcc flex bison dpkg-dev bc rsync kmod cpio libssl-dev libelf-dev git build-essential libncurses5-dev gcc-multilib g++-multilib python3 python3-pip python3-ply
